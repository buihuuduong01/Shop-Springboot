...
// phân trang
    ...
    public String enabledProduct(@PathVariable("id")Long id, RedirectAttributes attributes){
        try {
            ...
            e.printStackTrace();
            attributes.addFlashAttribute("error", "Hiển thị không thành công !");
        }
    ...
    public String deletedProduct(@PathVariable("id") Long id, RedirectAttributes attributes){
        try {
            ...
            attributes.addFlashAttribute("success", "Tắt thành công !");
        }catch (Exception e){
            e.printStackTrace();
            attributes.addFlashAttribute("error", "Tắt không thành công");
        }
        return "redirect:/products";
    }
}
